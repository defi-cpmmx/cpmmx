...
const  ETHERSCAN_API_KEY: &str = "9D7227RYHZW9BXZ7PY69XWPRGG81G4IRT1";

// // BSCScan
const BSCSCAN_URL: &str = "https://api.bscscan.com/api";
const BSCSCAN_API_KEY: &str = "IR1B9YAIJI2E8HBTIA2MPKUE61C9Z8NVS8";
        ...
        match scan {
            ...
            Network::BSC => {
                Self {
                    network: scan,
                    fork_url,
                    api_key: BSCSCAN_API_KEY.to_string(),
